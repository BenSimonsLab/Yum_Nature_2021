##### Comparing priming scores of WT epithelial cells for Confetti and Red2Onco models toward secretory lineage.
...
tmp_idx <- R2WT_sce_epi$celltype_int %in% c(1,2,5,6,7,8)
R2WT_sce_epi <- R2WT_sce_epi[,tmp_idx]
...
FB_df <- data.frame(FB_score=R2WT_ScTA_sce$FB_Goblet, cond_color=R2WT_ScTA_sce$cond_color2, stringsAsFactors = FALSE)
p <- ggplot(FB_df, aes(x=cond_color, y=FB_score, color=cond_color)) + 
  ...
  ggtitle("Priming score of WT epithelial cells for Confetti and Red2Onco models toward goblet cell lineage")

FB_df <- data.frame(FB_score=R2WT_ScTA_sce$FB_Paneth, cond_color=R2WT_ScTA_sce$cond_color2, stringsAsFactors = FALSE)
p <- ggplot(FB_df, aes(x=cond_color, y=FB_score, color=cond_color)) + 
  geom_boxplot() +
  coord_flip() + 
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ...
  ggtitle("Priming score of WT epithelial cells for Confetti and Red2Onco models toward Paneth cell lineage")

FB_df <- data.frame(FB_score=R2WT_ScTA_sce$FB_Tuft, cond_color=R2WT_ScTA_sce$cond_color2, stringsAsFactors = FALSE)
p <- ggplot(FB_df, aes(x=cond_color, y=FB_score, color=cond_color)) + 
  geom_boxplot() +
  coord_flip() + 
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ...
  ggtitle("Priming score of WT epithelial cells for Confetti and Red2Onco models toward tuft cell lineage")

FB_df <- data.frame(FB_score=R2WT_ScTA_sce$FB_EEC, cond_color=R2WT_ScTA_sce$cond_color2, stringsAsFactors = FALSE)
p <- ggplot(FB_df, aes(x=cond_color, y=FB_score, color=cond_color)) + 
  geom_boxplot() +
  coord_flip() + 
  geom_jitter(shape=16, position=position_jitter(0.2)) +
  ...
  ggtitle("Priming score of WT epithelial cells for Confetti and Red2Onco models toward EEC lineage")
